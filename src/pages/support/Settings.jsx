...
export default function SupportSettings() {
  ...
  const handleAvatarSelect = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/support/profile/avatar', formData, {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      const response = await api.put('/support/profile', { name });
  ...
  const handleSavePassword = async () => {
    ...
    try {
      ...
      await api.post('/support/profile/change-password', {
  ...
  return (
    <div className="max-w-5xl mx-auto w-full">
      <div className="mb-8">
        ...
        <p className="text-gray-500 font-medium mt-1">Manage your support staff profile</p>
      </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 sticky top-24">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="inline-flex items-center space-x-2 bg-blue-50 px-3 py-1.5 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                  <span className="text-sm font-black text-blue-600">Support Staff</span>
                </div>
              </div>
